...
const Card = () => {
    ...
    return (
        ...
        <div className='mt-5 md:mt-30 px-5 md:px-25'>
           ...
           <div>
            {
                user? <div className='grid lg:grid-cols-4 md:grid-cols-2 max-sm:grid-cols-1 gap-5 md:gap-10  py-15 overflow-hidden'>
                {
                   card.slice(0,4).map((data,i)=><div className='bg-neutral-50 rounded-2xl shadow-2xl px-3 py-3' key={i}>
                   ...
                   <div className='flex items-center justify-center py-5'>
                     <button className='btn bg-[#00c3b9] text-white rounded-4xl px-15 '>{data.button}</button>
                   </div>
            ...
            </div>: <div className='grid lg:grid-cols-4 md:grid-cols-2 max-sm:grid-cols-1 gap-5 md:gap-10  py-15 overflow-hidden'>
                {
            ...
            <div className='flex items-center justify-center py-5'>
                    <button onClick={handle} className='btn bg-[#00c3b9] text-white rounded-4xl px-15 text-xl '>
                        {user ? "Show Less" : "Show More"}
                    </button>
               </div>
