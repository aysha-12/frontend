...
const Card = () => {
    ...
    return (
        ...
        <div className='mt-5 md:mt-25 px-5 md:px-10 lg:px-20'>
           ...
           <div>
            {
                user? <div className='grid lg:grid-cols-3 xl:grid-cols-4 md:grid-cols-2 max-sm:grid-cols-2 gap-3 md:gap-10  py-15 overflow-hidden'>
                {
                   ...
                   <div className='flex items-center justify-center py-2 md:py-5'>
                     <button className='btn bg-[#00c3b9] text-base-100 rounded-4xl px-5 md:px-10  py-2  lg:text-xl  '>{data.button}</button>
                   </div>
            ...
            </div>: <div className='grid lg:grid-cols-4 md:grid-cols-2 max-sm:grid-cols-2 gap-3 md:gap-10  py-15 overflow-hidden'>
                {
                  card.map((data,i)=><div className='bg-neutral-50 rounded-2xl shadow-2xl  px-2 py-2' key={i}>
                   ...
                   <div className='flex items-center justify-center py-2 md:py-5'>
                     <button className='btn bg-[#00c3b9] text-base-100 rounded-4xl lg:text-xl py-2 px-5 md:px-10 '>{data.button}</button>
                   </div>
