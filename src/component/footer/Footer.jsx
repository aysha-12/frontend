...
const Footer = () => {
    return (
        <div className='bg-[#001716] py-10 md:py-15 rounded-t-4xl'>
           <div className='py-10 px-5 md:px-25 block md:flex justify-between '>
            <div>
                <img src={img} alt="" />
                <p className='text-neutral-400 mt-5' >Cutting-edge anti-aging solutions <br></br>designed for a healthier, more vibrant you.</p>
            ...
            <div>
                <p className='text-2xl text-neutral-200 mt-5 md:mt-0'>Company</p>
            ...
            <div>
                 <p className='text-2xl text-neutral-200  mt-5 md:mt-0'>Legal</p>
              <div className='block mt-3'>
             ...
             <div>
                 <p className='text-2xl text-neutral-200  mt-5 md:mt-0'>Newsletter</p>
              <div className='block mt-3'>
  ...
  <button className="btn bg-[#00c3b9]  join-item">Subscribe  </button>
</div>
              </div>
          ...
          <p className='text-center text-neutral-400 mt-5'>© 2025 Relive Anti-Aging Clinic. All rights reserved.</p>
        </div>
    );
};
