...
const Slider = () => {
    ...
    backgroundImage:`url(${img})`,
                ...
                <div className='flex justify-start  px-5 md:px-25'>
                    ...
                    <h1 className='text-3xl md:text-8xl text-white'>Rediscover Youth, <span className='text-[#00c3b9]'> Redefine Life.</span></h1>
                   ...
                   <button className="btn bg-[#00c3b9]  p-6 mt-5 text-white rounded-full text-[16px] ">Contact Us</button>
