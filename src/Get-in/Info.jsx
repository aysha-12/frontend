...
const Info = () => {
    return (
        <div>
                  <section>
                    <div className='mt-10 px-5 shadow-2xl md:px-10 bg-white py-10 md:py-15 rounded-2xl'>
                          ...
                          <div>
                              <p className=" text-xl font-semibold mt-8 mb-3  md:text-2xl">Business Hours</p>
                            <p className='mt-3 md:text-xl'>Monday - Friday: 9:00 AM - 7:00 PM</p>
                            <p className='mt-3 md:text-xl'>Saturday: 10:00 AM - 4:00 PM</p>
                            <p className='mt-3 md:text-xl'>Sunday: Closed</p>
                          </div>
